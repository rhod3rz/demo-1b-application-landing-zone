...
# Nodes = from dedicated byo subnet e.g. snet-nteu-grn-nodes
...
uamis = {
  ...
  # grne & green clusters must have their own unique uami because they each need a federated identity called 'azure-alb-identity'.
  uami-aks-prd-nteu-grn = {
...
uami_role_assignments_resource = {
  # assign 'uami-aks-prd-nteu-grn' uami 'Private DNS Zone Contributor' role to privatelink.northeurope.azmk8s.io.
  uami-aks-prd-nteu-grn-to-dns = {
    uami_name = "uami-aks-prd-nteu-grn"
    # target
  ...
  # assign 'uami-aks-prd-nteu-grn' uami 'Network Contributor' role to snet-nteu-agfc - required for agfc.
  uami-aks-prd-nteu-grn-to-agfc-subnet = {
    uami_name = "uami-aks-prd-nteu-grn"
    # target
    subscription_id      = "2bc7b65e-18d6-42ae-afb2-e66d50be6b05"
    resource_group_name  = "rg-prd-nteu-aks"
    resource_type        = "Microsoft.Network/virtualNetworks"
    resource_name        = "vnet-prd-nteu-aks/subnets/snet-nteu-grn-agfc"
    role_definition_name = "Network Contributor"
  }
  # assign permission to itself to prevent errors when using the uami for the kubelet identity.
  uami-aks-prd-nteu-grn-on-self = {
    uami_name = "uami-aks-prd-nteu-grn"
    # target
    subscription_id      = "2bc7b65e-18d6-42ae-afb2-e66d50be6b05"
    resource_group_name  = "rg-prd-nteu-aks"
    resource_type        = "Microsoft.ManagedIdentity/userAssignedIdentities"
    resource_name        = "uami-aks-prd-nteu-grn"
...
uami_role_assignments_resource_groups = {
  # assign 'uami-aks-prd-nteu-grn' uami 'Reader' role to resource group - required for agfc.
  uami-aks-prd-nteu-grn-reader-to-rg = {
    uami_name = "uami-aks-prd-nteu-grn"
    # target
    subscription_id      = "2bc7b65e-18d6-42ae-afb2-e66d50be6b05"
    resource_group_name  = "rg-prd-nteu-aks"
  ...
  # assign 'uami-aks-prd-nteu-grn' uami 'AppGw for Containers Configuration Manager' role to resource group - required for agfc.
  ...
  kv-aks-prd-nteu = {
    ...
    role_assignments = {
      ...
      ra3 = {
        ...
        principal_id_or_uami_name        = "uami-aks-prd-nteu-grn" # name of the uami to resolve via the locals block.
...
clusters = {
  aks-prd-nteu-grn = {
    resource_group_name      = "rg-prd-nteu-aks"
    node_resource_group_name = "rg-prd-nteu-aks-grn-nrg"
    ...
    default_node_pool = {
      ...
      max_pods             = 100
      zones                = ["1", "2", "3"]
      vnet_subnet_id       = "/subscriptions/2bc7b65e-18d6-42ae-afb2-e66d50be6b05/resourceGroups/rg-prd-nteu-aks/providers/Microsoft.Network/virtualNetworks/vnet-prd-nteu-aks/subnets/snet-nteu-grn-nodes"
      pod_subnet_id        = null
      upgrade_settings = {
...
federated_identitys = {
  ...
  fi1 = {
    ...
    parent_id           = "uami-aks-prd-nteu-grn"                                    # uami name.
    issuer              = "aks-prd-nteu-grn"                                         # aks cluster name.
...
gateways = {
  agfc-prd-nteu-grn = {
    resource_group_name = "rg-prd-nteu-aks"
    gateway_name        = "agfc-prd-nteu-grn"
    subnet_name         = "snet-nteu-grn-agfc"
    subnet_id           = "/subscriptions/2bc7b65e-18d6-42ae-afb2-e66d50be6b05/resourceGroups/rg-prd-nteu-aks/providers/Microsoft.Network/virtualNetworks/vnet-prd-nteu-aks/subnets/snet-nteu-grn-agfc"
    gateway_frontends = {
      # a frontend per root domain (max 5) e.g. rhod3rz.com, test3rz.com etc.
      rhod3rz-com = {
        dns_cname_records = {
          agfc-prd-grn-mango-cart = {
            name                = "agfc.prd.grn.mango.cart" # must be prefixed agfc as prd.grn.mango.cart will be used as a cname to frontdoor.
            zone_name           = "rhod3rz.com"
            resource_group_name = "rg-core-01"
            ttl                 = 300
          }
          agfc-prd-grn-mango-catalog = {
            name                = "agfc.prd.grn.mango.catalog" # must be prefixed agfc as prd.grn.mango.catalog will be used as a cname to frontdoor.
            zone_name           = "rhod3rz.com"
            resource_group_name = "rg-core-01"
            ttl                 = 300
          }
