...
# cni + azure firewall | Network Configuration : Azure CNI Pod Subnet
...
clusters = {
  aks-prd-nteu-blu = {
    ...
    api_server_access_profile = {
      ...
      authorized_ip_ranges = ["86.10.95.19/32", "48.209.180.7/32"] # if using azure firewall; ensure to include the ip in here!
      # 86.10.95.19/32  = rhodri home
      # 48.209.180.7/32 = azure firewall
    }
    ...
    default_node_pool = {
      ...
      pod_subnet_id        = "/subscriptions/2bc7b65e-18d6-42ae-afb2-e66d50be6b05/resourceGroups/rg-prd-nteu-aks/providers/Microsoft.Network/virtualNetworks/vnet-prd-nteu-aks/subnets/snet-nteu-blu-pods"
      upgrade_settings = {
    ...
    network_profile = {
      ...
      pod_cidr            = null
      load_balancer_sku   = null                 # set to "standard" when using userAssignedNATGateway | set to null when using userDefinedRouting.
      outbound_type       = "userDefinedRouting" # loadBalancer | userAssignedNATGateway | userDefinedRouting | for 'userDefinedRouting' route table next hop must be 'virtualappliance'.
